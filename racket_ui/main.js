...
web_socket.onmessage = function (event) {
  ...
  var acel_eixo_y = document.getElementsByClassName('acel_eixo_y')
  acel_eixo_y[0].innerHTML = `eixo Y: ${acel_eixo_y_data}`
  var acel_eixo_z_data = json[keys[0]]['values'][2]
  var acel_eixo_z = document.getElementsByClassName('acel_eixo_z')
  acel_eixo_z[0].innerHTML = `eixo X: ${acel_eixo_z_data}`
  ...
  var giro_eixo_y = document.getElementsByClassName('giro_eixo_y')
  giro_eixo_y[0].innerHTML = `eixo Y: ${giro_eixo_y_data}`
  var giro_eixo_z_data = json[keys[1]]['values'][2]
  var giro_eixo_z = document.getElementsByClassName('giro_eixo_z')
  giro_eixo_z[0].innerHTML = `eixo X: ${giro_eixo_z_data}`
